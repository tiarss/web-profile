...
export const metadata: Metadata = {
  title: 'Portfolio | Tiar Subrata - Frontend Developer',
  ...
  keywords: ['frontend developer', 'web developer', 'react', 'typescript', 'next.js', 'frontend developer', 'portfolio'],
  icons: {
    icon: '/favicon.ico',
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://tiarss.vercel.app/portfolio',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tiar Subrata Portfolio - Frontend Developer',
      },
    ],
  },
  // twitter: {
